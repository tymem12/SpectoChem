...
class Config(BaseModel, extra="forbid"):
    ...
    pos_encoding_graph_level: PosEncodingConfig
    random_seed: int


@hydra.main(version_base="1.3", config_path="../../config", config_name="pos_encoding_graph_level")
def main(cfg: DictConfig) -> None:
    resolved_config = resolve_config(cfg)
    dataset_config = resolved_config['dataset']
    pos_encoding_config = resolved_config['pos_encoding_graph_level']
